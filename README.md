...
| **`largeIcon`**        | <code>string</code>                           | Set a large icon for notifications. Icons should be placed in your app's `res/drawable` folder. The value for this option should be the drawable resource ID, which is the filename without an extension. It can be a valid Base64 url. Only available for Android.                                                                                                                                                                                                                                                                                                                                                             | 1.0.0 |
| **`circledLargeIcon`** | <code>boolean</code>                          | Set circled shape to the large icon. Only available for Android.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | 1.0.0 |
...
| Prop                 | Type                                                    | Description                                                                                                                                                                                                                                                                                                                             | Since |
| -------------------- | ------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----- |
| **`at`**             | <code>string</code>                                     | <a href="#schedule">Schedule</a> a notification at a specific date and time.                                                                                                                                                                                                                                                            | 1.0.0 |
